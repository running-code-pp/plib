#ifndef PLIB_CORE_UTILS_SMALL_VECTOR_HPP
#define PLIB_CORE_UTILS_SMALL_VECTOR_HPP

/**
 take from taskflow

 small_vector is often used for temporary small dynamic arrays
 and can improve performance compared to std::vector.
 */
...
namespace plib::core::utils
{
    ...
    */
    ...
    protected:
        ...
        /// 这是grow()方法的实现，仅适用于POD类型数据，且放在类外以减少代码重复。
