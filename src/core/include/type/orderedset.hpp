#ifndef PLIB_CORE_TYPE_ORDERED_SET_HPP
#define PLIB_CORE_TYPE_ORDERED_SET_HPP
...
public:
	...
	inline list<T> values() const { return impl_.keys(); }
...
#endif // PLIB_CORE_TYPE_ORDERED_SET_HPP