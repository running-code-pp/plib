#ifndef PLIB_CORE_TYPE_FLATMAP_HPP
#define PLIB_CORE_TYPE_FLATMAP_HPP
#include <vector>
#include <algorithm>
...
namespace std {
	...
	template <typename Key, typename Value>
	class tuple_size<plib::core::type::flat_multi_map_pair_type<Key, Value>>
		: public integral_constant<size_t, 2> {
	};

	template <typename Key, typename Value>
	class tuple_element<0, plib::core::type::flat_multi_map_pair_type<Key, Value>> {
	public:
		using type = const Key;
	};

	template <typename Key, typename Value>
	class tuple_element<1, plib::core::type::flat_multi_map_pair_type<Key, Value>> {
	public:
		using type = Value;
	};
...
namespace plib::core::type {
	...
	template <std::size_t N, typename Key, typename Value>
	auto get(flat_multi_map_pair_type<Key, Value>& value)
	...
	template <std::size_t N, typename Key, typename Value>
	auto get(const flat_multi_map_pair_type<Key, Value>& value)
...
#endif // PLIB_CORE_TYPE_FLATMAP_HPP